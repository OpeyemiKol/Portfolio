  ...
  return (
    <section id="about" className="min-h-screen py-24 px-6 text-white">
      ...
      <h1 className="relative text-6xl md:text-7xl font-barlow tracking-widest font-bold text-center mb-20">
        <HiUser className="inline" /> Who I Am
      ...
      <div className="max-w-6xl font-bellefair mx-auto grid md:grid-cols-2 gap-12">
        {/* About Me */}
        <div className="bg-gray-800/60 p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-shadow duration-500">
        ...
        {/* Outside Work */}
        <div className="bg-gray-800/60 p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-shadow duration-500 md:col-span-2 text-center">
          <h2 className="text-4xl text-teal-400 font-semibold mb-6 border-b border-teal-500 pb-2">
            Outside Work
          </h2>
          <p className="text-2xl leading-relaxed">
