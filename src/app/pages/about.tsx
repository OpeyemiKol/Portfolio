...
export default function About() {
  return (
    <section id="about" className="min-h-screen py-20 px-5 text-white">
      {/* Section Title */}
      <motion.h1
        ...
        className="relative text-4xl font-barlow tracking-widest font-bold text-center mb-10"
      >
      ...
      {/* Content Grid */}
      <div className="max-w-6xl font-bellefair mx-auto grid lg:grid-cols-2 gap-10">
        {/* About Me */}
        <motion.div
        ...
        >
          <h2 className="text-2xl text-teal-400 font-semibold mb-4 border-b border-teal-500 pb-2">
            About Me
          </h2>
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: false, amount: 0.3 }}
          className="bg-gray-800/60 p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-shadow duration-500 lg:col-span-2 text-center"
        >
          <h2 className="text-2xl text-teal-400 font-semibold mb-4 border-b border-teal-500 pb-2">
            Outside Work
          </h2>
